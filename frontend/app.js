        ...
        try {
            ...
            if (data.databases && dom.dbSelect) {
                ...
                dom.dbSelect.addEventListener('change', (e) => {
                    if (e.target.value) {
                         const base_url = "postgresql://neondb_owner:npg_UCdk9eMi2vGn@ep-mute-firefly-amtmu27v-pooler.c-5.us-east-1.aws.neon.tech/" + e.target.value + "?sslmode=require&channel_binding=require";
                         dom.dbUrlInput.value = base_url;
                    }
                });
            }
        } catch (e) {
